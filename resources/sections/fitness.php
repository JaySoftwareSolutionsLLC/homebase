...
<h2>Fitness</h2>
	<div class="content">
        ...
        <div class="stats">
        	...
        	<div class="stat">
        		<h4 class="name">Body Weight</h4>
        		<h4 class="value"><?php echo $most_recent_body_weight; ?> lbs</h4>
        	</div>
        	<div class="stat">
        		<h4 class="name">Ready Muscles</h4>
        		<h4 class="value"><?php echo $number_ready_muscles; ?> / <?php echo $number_total_muscles; ?></h4>
        	</div>
        	<div class="stat">
        		<h4 class="name">Percent Ideal</h4>
        		<h4 class="value"><?php echo $body_net_percent_ideal; ?>%</h4>
        	</div>
        	<div class="stat">
        	...
        	<div class="stat">
        		...
        		<h4 class="value"><?php echo $number_near_ideal_muscles; ?> / <?php echo $number_total_muscles; ?></h4>
        	</div>        	
		</div>
		<div class="row">
			<a href='/homebase/resources/forms/generate_lift_inputs.php' class="form generate-workout" target='_blank'>
				<img src='resources/assets/images/icon-generate-lift.png'/>
				<figcaption>Gen. Lift</figcaption>
			</a>
			<a href='/homebase/resources/forms/log_lift.php' class="form lifts" target='_blank'>
				<img src='resources/assets/images/icon-log-lift.png'/>
		...
		<div class="row">
			...
			<a href='/homebase/resources/forms/circumferences.php' class="form measuring-tape" target='_blank'>
...
<script>
	...
	var muscleObjects = [];
<?php
	foreach ($muscle_objects as $m) {
?>
		muscleObjects.push(<?php echo json_encode($m); ?>);
<?php
	}
?>
	//TEST console.log(muscleObjects);
	
	muscleObjects.forEach(function(m) {
		//TEST console.log(m);
	});
