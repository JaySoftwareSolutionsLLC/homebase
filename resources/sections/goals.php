...
<?php		
		...
		echo return_timed_goal_progress_bar_html('Arm Size', 'goal-arm-size', STARTING_UPPER_ARM_CIRC, UPPER_ARM_CIRC_TARGET, $most_recent_upper_arm_size, START_DATE_STRING_UPPER_ARM_CIRC, '2019-12-31', 'now', 'polynomial', null); // Defined in homebase/resources/resources.php
		...
		echo return_timed_goal_progress_bar_html('Opt. Health', 'goal-optimal-health', 0, 85, 0, null, null); // Defined in homebase/resources/resources.php
