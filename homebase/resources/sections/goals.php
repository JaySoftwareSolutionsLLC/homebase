...
<?php		
		...
		echo return_timed_goal_progress_bar_html('Open Source', 'goal-open-source-hours', 0, 100, 0/*12*/, '2019-01-01', '2019-12-31');

		echo return_timed_goal_progress_bar_html('Pickup Sports', 'goal-pickup-sport-sessions', 0, 78, 0/*1*/, '2019-01-01', '2019-12-31');

		echo return_timed_goal_progress_bar_html('Relax Sessions', 'goal-spiritual-sessions', 0, 156, 0/*3*/, '2019-01-01', '2019-12-31');
